...
namespace Pulumi.K8sapp
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-pequod/pequod-mlc-servicedeployment";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.K8sapp.version.txt");
    ...
    internal sealed class K8sappResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public K8sappResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
