...
namespace Pulumi.Gke
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-pequod/pequod-mlc-gke";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Gke.version.txt");
    ...
    internal sealed class GkeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GkeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
